...
API_ROUTES = ApiRouteRegistry(sum((
    routes("GET", r"/api/health", r"/api/me", r"/api/models", r"/api/metrics", r"/api/apps", r"/api/tools", r"/api/tool-invocations", r"/api/(?:memories|knowledge|artifacts|threads|folders|skills|runs)", r"/api/knowledge/search", r"/api/artifacts/[^/]+/download", r"/api/folders/[^/]+", r"/api/runs/[^/]+", r"/api/threads/[^/]+(?:/(?:runs|context|skills))?", r"/api/skills/[^/]+(?:/versions)?"),
    routes("POST", r"/api/login", r"/api/logout", r"/api/logout-all", r"/api/(?:skills|knowledge|memories|threads|folders|chat|route-preview)", r"/api/memories/candidates", r"/api/skills/[^/]+/restore", r"/api/folders/[^/]+/(?:knowledge|invitations)", r"/api/runs/[^/]+/(?:confirmation|cancel|feedback)", r"/api/tools/[^/]+/execute"),

...
API_ROUTES = ApiRouteRegistry(sum((
    routes("GET", r"/api/health", r"/api/me", r"/api/models", r"/api/metrics", r"/api/retrieval-diagnostics", r"/api/retrieval-suggestions", r"/api/retrieval-policies", r"/api/apps", r"/api/tools", r"/api/tool-invocations", r"/api/(?:memories|knowledge|artifacts|threads|folders|skills|runs)", r"/api/knowledge/search", r"/api/artifacts/[^/]+/download", r"/api/folders/[^/]+", r"/api/runs/[^/]+", r"/api/threads/[^/]+(?:/(?:runs|context|skills))?", r"/api/skills/[^/]+(?:/versions)?"),
